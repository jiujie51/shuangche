...
void DMA0_IRQHandler(void)
{
 ...
 int16  speed_count1 = 0;
 int16  speed_count2 = 0;
...
void PIT1_IRQHandler(void)
{
  ...
  speed_count1 = ftm_quad_get(ftm1);
	speed_count2=ftm_quad_get(ftm2);
	
//	printf("%d\n",speed1);

//	send_dummy_date(speed_count2);
...
//	if(pwm_flag)
		...
		car_speed_control_left(speed_count1);
		car_speed_control_right(speed_count2);
